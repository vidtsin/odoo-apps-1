...
class SmsTemplate(models.Model):
    ...
    is_birthday = fields.Boolean(string="SMS for birthday")
    ...
    def send_sms(self, template_id, record_id):
        ...
        self.env['ir.model.data'].get_object('proxima_sms', 'sms_queue_check').active = True
        return rendered_sms_template_body
